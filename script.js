...
let noCount = 0;
const noTexts = ["No? Bura lag rha hai mere ko. 😢", "Soch lo! 🥺", "Please? 👉👈", "Pakka? 😭", "Machupichu! ❤️‍🩹", "Maar khaega noobie! 😠", "French bulldog dilaunga. 🐶", "Ghumi ghumi bhi kraunga! ✈️", "Maanjao na, kitna bhav khoge. 😒"];
...
setInterval(() => createFloatingEmoji(false), 300);
for (let i = 0; i < 15; i++) createFloatingEmoji(true);
...
function startSparkles() {
  ...
  for (let i = 0; i < 1000; i++) {
    setTimeout(() => {
      ...
      spark.style.animationDuration = Math.random() * 2.5 + 2 + "s";
